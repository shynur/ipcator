...
class Shared_Memory {
    ...
    public:
        ...
        [[gnu::always_inline]] Shared_Memory(const Shared_Memory<other_creates, writable_other>& other)
        noexcept requires(!creat): Shared_Memory{other.get_name()} {
        ...
        [[gnu::always_inline]] friend void swap(Shared_Memory& a, decltype(a) b)
        noexcept {
         ...
         */
        [[gnu::always_inline]] auto& operator=(Shared_Memory other) noexcept {
            swap(*this, other);
            return *this;
        }
        /**
